...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "oxylus.py"

        #Name of program
        self.project_name = "Oxylus"
        ...
        #Auhor of program
        self.author_name = "Anton Wiehe, Nil Stolt Anso, Francesco Dal Canton"
        self.author_email = "antonwiehe@gmail.com"
        self.copyright = "Copyright (c) 2017 Anton Wiehe."

        #Description
        self.project_description = "This program guides the user to a choice of wood type used for a project that he envisions."

        #Icon file (None will use pygame default icon)
        self.icon_file = "log32.ico"
