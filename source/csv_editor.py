...
with open('data.csv', 'w') as writeFile:
    ...
    maxima = []
    maxima.extend([1040.0, 3.0, 21.6, 5.0, 5.0, 3.0, 3.0, 3.0, 2.0])
    minima = []
    minima.extend([150.0, 1.0, 7.8, 1.0, 1.0, 1.0, 0.0, 0.0, 0.0])
    for i, row in enumerate(out):
        for j, column in enumerate([3, 4, 5, 6, 7, 8, 10, 11, 12]):
